  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(
       ...
       cursorColor: Color.fromRGBO(185,194,126, 1),
       highlightColor: Color.fromRGBO(185,194,126, 1),
       primaryColor: Color.fromRGBO(185,194,126, 1),
       accentColor: Color.fromRGBO(241,242,190, 1)
    //  splashColor: 
      ),
